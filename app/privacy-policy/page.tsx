const PoliticaPrivacidade = () => {
    return (
        <div className="pl-2">
            ...
            <div className="pt-2"/>
            <p className="text-xl">
                Esta Política de Privacidade visa informar nossos usuários sobre a coleta, uso e proteção dos seus dados pessoais, bem como garantir a transparência e conformidade com a LGPD e a Google API Services User Data Policy.
            </p>
            <div className="pt-2"/>
            {/* ITEM 4 */}
            ...
            <p className="text-xl">
                ...
                <ul className="list-disc pl-6">
                    ...
                    <li>Sincronização de Eventos: Os dados do Google Calendar são utilizados exclusivamente para sincronizar e organizar seus eventos no aplicativo, facilitando a visualização e o gerenciamento das suas atividades.</li>
                </ul>
            </p>
            <div className="pt-2"/>
            {/* ITEM 6 */}
            <h3 className="text-xl font-bold">6. Solicitação de Permissões</h3>
            <div className="pt-2"/>
            <p className="text-xl">
                Solicitamos acesso aos seus dados do Google Calendar apenas no momento em que você ativar funcionalidades que dependem dessas informações, garantindo que você tenha controle total sobre os dados que compartilha conosco.
            </p>
            <div className="pt-2"/>
            {/* ITEM 7 */}
            <h3 className="text-xl font-bold">7. Compartilhamento de Dados</h3>
            <div className="pt-2"/>
            <p className="text-xl">
            ...
            <div className="pt-2"/>
            {/* ITEM 8 */}
            <h3 className="text-xl font-bold">8. Exigências Legais</h3>
            <div className="pt-2"/>
            <p className="text-xl">
            ...
            <div className="pt-2"/>
            {/* ITEM 9 */}
            <h3 className="text-xl font-bold">9. Medidas de Segurança</h3>
            <div className="pt-2"/>
            <p className="text-xl">
                Implementamos medidas de segurança para proteger seus dados pessoais, incluindo criptografia e controles de acesso restrito a funcionários autorizados. Garantimos que seus dados estão seguros em trânsito e em repouso.
            </p>
            <div className="pt-2"/>
            {/* ITEM 10 */}
            <h3 className="text-xl font-bold">10. Opção de Exclusão</h3>
            <div className="pt-2"/>
            <p className="text-xl">
            ...
            <div className="pt-2"/>
            {/* ITEM 11 */}
            <h3 className="text-xl font-bold">11. Atualizações da Política</h3>
            <div className="pt-2"/>
            <p className="text-xl">
            ...
            <div className="pt-2"/>
            {/* ITEM 12 */}
            <h3 className="text-xl font-bold">12. Contato</h3>
            <div className="pt-2"/>
            <p className="text-xl">
