        ...
        <Popover>
            ...
            >
                <div className="relative h-96 w-full mb-2"> {/* Adicionando margem inferior para espaçamento */}
                    <Image
                        src="/Mensal.svg" // Verifique se este caminho está correto
                        alt="Template de Planner Mensal"
                        fill
                ...
                <a 
                    href="/Planner-Mensal.pdf" // Caminho do arquivo na pasta public
