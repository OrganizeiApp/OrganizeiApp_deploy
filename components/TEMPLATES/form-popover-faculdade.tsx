        ...
        <Popover>
            ...
            >
                <div className="relative h-96 w-full mb-2"> {/* Adicionando margem inferior para espaçamento */}
                    <Image
                        src="/Faculdade.svg" // Verifique se este caminho está correto
                        alt="Template de controle de rotina de estudos para Faculdade"
                        fill
                ...
                <a 
                    href="/Faculdade.pdf" // Caminho do arquivo na pasta public
