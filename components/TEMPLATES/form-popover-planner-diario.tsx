        ...
        <Popover>
            ...
            >
                <div className="relative h-96 w-full mb-2"> {/* Adicionando margem inferior para espaçamento */}
                    <Image
                        src="/Diário.svg" // Verifique se este caminho está correto
                        alt="Template de Planner Diário"
                        fill
                ...
                <a 
                    href="/Planner-Diário.pdf" // Caminho do arquivo na pasta public
