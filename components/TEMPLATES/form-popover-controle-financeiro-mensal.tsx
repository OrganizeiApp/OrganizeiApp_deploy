        ...
        <Popover>
            ...
            >
                <div className="relative h-96 w-full mb-2"> {/* Adicionando margem inferior para espaçamento */}
                    <Image
                        src="/financeiro Mensal.svg" // Verifique se este caminho está correto
                        alt="Template de Controles Financeiros Mensais"
                        fill
                ...
                <a 
                    href="/Controle-Financeiro-Mensal.pdf" // Caminho do arquivo na pasta public
