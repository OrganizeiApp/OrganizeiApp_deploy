        ...
        <Popover>
            ...
            >
                <div className="relative h-96 w-full mb-2"> {/* Adicionando margem inferior para espaçamento */}
                    <Image
                        src="/financeiro Semanal.svg" // Verifique se este caminho está correto
                        alt="Template de Controles Financeiros Semanais"
                        fill
                ...
                <a 
                    href="/Controle-Financeiro-Semanal.pdf" // Caminho do arquivo na pasta public
