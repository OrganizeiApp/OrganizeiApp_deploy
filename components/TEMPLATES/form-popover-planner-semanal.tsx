        ...
        <Popover>
            ...
            >
                <div className="relative h-96 w-full mb-2"> {/* Adicionando margem inferior para espaçamento */}
                    <Image
                        src="/Semanal.svg" // Verifique se este caminho está correto
                        alt="Template de Planner Semanal"
                        fill
                ...
                <a 
                    href="/Planner-Semanal.pdf" // Caminho do arquivo na pasta public
