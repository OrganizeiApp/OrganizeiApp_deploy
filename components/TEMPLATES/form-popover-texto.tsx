        ...
        <Popover>
            ...
            >
                <div className="relative h-96 w-full mb-2"> {/* Adicionando margem inferior para espaçamento */}
                    <Image
                        src="/Texto.svg" // Verifique se este caminho está correto
                        alt="Template para realização de textos"
                        fill
                ...
                <a 
                    href="/Texto.pdf" // Caminho do arquivo na pasta public
